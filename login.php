  ...
  <body>
      ...
      <div class="card mx-auto col-md-6">
        ...
        <div class="card-body">
          ...
          <input type="text"  id="usr" class="form-control" name="username" placeholder="Username" required />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
          <input type="submit" name="submit" placeholder="Login" class="btn btn-success" />
          </div>
          </form>
